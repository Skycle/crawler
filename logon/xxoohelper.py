...
class mailhelper(object):
    ...
    def __init__(self):
        ...
        self.mail_user="261008760@qq.com"    #用户名
        self.mail_pass="Ldw13Ting14"   #密码
...
class xxoohelper(object):
    ...
    '''
    def __init__(self):
        self.url = 'http://weibo.cn/qiubomm' #请输入准备抓取的微博地址
    ...
    def getData(self,html):
        ...
        data = {
            ...
            'remember' : 'on',
            'backURL' : 'http://weibo.cn/qiubomm', #此处请修改为微博地址
            'backTitle' : u'微博',
            'tryCount' : '',
            'vk' : vk,
            'submit' : u'登录'
...
if __name__ == '__main__':
    mailto_list=['caigen007@foxmail.com'] #此处填写接收邮件的邮箱
    helper = xxoohelper()
    while True:
